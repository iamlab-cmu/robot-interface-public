#ifndef IAM_ROBOLIB_TERMINATION_HANDLER_TIME_TERMINATION_HANDLER_H_
#define IAM_ROBOLIB_TERMINATION_HANDLER_TIME_TERMINATION_HANDLER_H_
...
#endif  // IAM_ROBOLIB_TERMINATION_HANDLER_TIME_TERMINATION_HANDLER_H_