...
class SkillInfo : public BaseSkill {
 public:
   ...
   * @param result_buffer
   */
  void write_result_to_shared_memory(SharedBufferType result_buffer) override;

  /**
   * Write result to the shared memory after skill is done.
   * @param result_buffer
   */
  void write_result_to_shared_memory(SharedBufferType result_buffer, 
   ...
   */
  void write_feedback_to_shared_memory(SharedBufferType feedback_buffer) 
                                                                      override;
