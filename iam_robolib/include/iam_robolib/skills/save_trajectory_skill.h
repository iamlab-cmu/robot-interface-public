...
class SaveTrajectorySkill : public BaseSkill {
 public:
  SaveTrajectorySkill(int skill_idx, int meta_skill_idx, 
 ...
 private:
  ...
  // Not using a mutex is ok, in the worst case we will just lose 1 or 2 data 
  // points. Hopefully, nothing bad.
