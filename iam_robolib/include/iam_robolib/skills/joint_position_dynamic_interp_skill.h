#ifndef IAM_ROBOLIB_SKILLS_JOINT_POSITION_DYNAMIC_INTERP_SKILL_H_
#define IAM_ROBOLIB_SKILLS_JOINT_POSITION_DYNAMIC_INTERP_SKILL_H_
...
#endif  // IAM_ROBOLIB_SKILLS_JOINT_POSITION_DYNAMIC_INTERP_SKILL_H_