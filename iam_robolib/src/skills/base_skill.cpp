...
void BaseSkill::write_result_to_shared_memory(double* result_buffer) {
  std::cout << "Should write result to shared memory\n";
}

void BaseSkill::write_result_to_shared_memory(double* result_buffer, FrankaRobot* robot) {
  std::cout << "Should write result to shared memory\n";
}

void BaseSkill::write_result_to_shared_memory(double* result_buffer, Robot* robot) {
  std::cout << "Should write result to shared memory\n";
}

void BaseSkill::write_feedback_to_shared_memory(double* feedback_buffer) {
