...
"""autogenerated by genpy from franka_action_lib/GetCurrentRobotStateCmdRequest.msg. Do not edit."""
import sys
...
class GetCurrentRobotStateCmdRequest(genpy.Message):
  ...
  _type = "franka_action_lib/GetCurrentRobotStateCmdRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from franka_action_lib/GetCurrentRobotStateCmdResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetCurrentRobotStateCmdResponse(genpy.Message):
  _md5sum = "9d11d5ba31b9f0ae529e9a5c66e25ee4"
  _type = "franka_action_lib/GetCurrentRobotStateCmdResponse"
  _has_header = False #flag to mark the presence of a Header object
...
bool joint_move_in_wrong_direction"""
  ...
  _slot_types = ['franka_action_lib/RobotState']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.robot_state is None:
        self.robot_state = franka_action_lib.msg.RobotState()
    else:
      self.robot_state = franka_action_lib.msg.RobotState()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.robot_state.header.frame_id = str[start:end].decode('utf-8')
      else:
...
class GetCurrentRobotStateCmd(object):
  _type          = 'franka_action_lib/GetCurrentRobotStateCmd'
  _md5sum = '9d11d5ba31b9f0ae529e9a5c66e25ee4'
