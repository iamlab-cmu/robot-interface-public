...
"""autogenerated by genpy from franka_action_lib/RunLoopProcessInfoState.msg. Do not edit."""
import sys
...
class RunLoopProcessInfoState(genpy.Message):
  ...
  _type = "franka_action_lib/RunLoopProcessInfoState"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.current_skill_description = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.new_skill_description = str[start:end].decode('utf-8')
      else:
