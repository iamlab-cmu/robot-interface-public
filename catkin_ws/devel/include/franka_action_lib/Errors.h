// Generated by gencpp from file franka_action_lib/Errors.msg
// DO NOT EDIT!


#ifndef FRANKA_ACTION_LIB_MESSAGE_ERRORS_H
#define FRANKA_ACTION_LIB_MESSAGE_ERRORS_H
...
struct Errors_
{
  ...
  typedef boost::shared_ptr< ::franka_action_lib::Errors_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::franka_action_lib::Errors_<ContainerAllocator> const> ConstPtr;

}; // struct Errors_

typedef ::franka_action_lib::Errors_<std::allocator<void> > Errors;

typedef boost::shared_ptr< ::franka_action_lib::Errors > ErrorsPtr;
typedef boost::shared_ptr< ::franka_action_lib::Errors const> ErrorsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::franka_action_lib::Errors_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::franka_action_lib::Errors_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::franka_action_lib::Errors_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::franka_action_lib::Errors_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::franka_action_lib::Errors_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::franka_action_lib::Errors_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::franka_action_lib::Errors_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::franka_action_lib::Errors_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::franka_action_lib::Errors_<ContainerAllocator> >
{
  ...
  static const char* value(const ::franka_action_lib::Errors_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb93c14a039f7f69dULL;
  static const uint64_t static_value2 = 0x7321c619961e4708ULL;
};

template<class ContainerAllocator>
struct DataType< ::franka_action_lib::Errors_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::franka_action_lib::Errors_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::franka_action_lib::Errors_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::franka_action_lib::Errors_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::franka_action_lib::Errors_<ContainerAllocator>& v)
  {
...
#endif // FRANKA_ACTION_LIB_MESSAGE_ERRORS_H
