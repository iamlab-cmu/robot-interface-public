// Generated by gencpp from file franka_action_lib/RobotState.msg
// DO NOT EDIT!


#ifndef FRANKA_ACTION_LIB_MESSAGE_ROBOTSTATE_H
#define FRANKA_ACTION_LIB_MESSAGE_ROBOTSTATE_H
...
#include <franka_action_lib/Errors.h>
#include <franka_action_lib/Errors.h>
...
struct RobotState_
{
  ...
  _dtheta_type dtheta;
   ...
   typedef  ::franka_action_lib::Errors_<ContainerAllocator>  _current_errors_type;
  _current_errors_type current_errors;

   typedef  ::franka_action_lib::Errors_<ContainerAllocator>  _last_motion_errors_type;
  ...
  typedef boost::shared_ptr< ::franka_action_lib::RobotState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::franka_action_lib::RobotState_<ContainerAllocator> const> ConstPtr;

}; // struct RobotState_

typedef ::franka_action_lib::RobotState_<std::allocator<void> > RobotState;

typedef boost::shared_ptr< ::franka_action_lib::RobotState > RobotStatePtr;
typedef boost::shared_ptr< ::franka_action_lib::RobotState const> RobotStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::franka_action_lib::RobotState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::franka_action_lib::RobotState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::franka_action_lib::RobotState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::franka_action_lib::RobotState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::franka_action_lib::RobotState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::franka_action_lib::RobotState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::franka_action_lib::RobotState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::franka_action_lib::RobotState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::franka_action_lib::RobotState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::franka_action_lib::RobotState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6661b990bbd6c347ULL;
  static const uint64_t static_value2 = 0x863e2d70cb526607ULL;
};

template<class ContainerAllocator>
struct DataType< ::franka_action_lib::RobotState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::franka_action_lib::RobotState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::franka_action_lib::RobotState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::franka_action_lib::RobotState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::franka_action_lib::RobotState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << std::endl;
    Printer< ::franka_action_lib::Errors_<ContainerAllocator> >::stream(s, indent + "  ", v.current_errors);
    s << indent << "last_motion_errors: ";
    s << std::endl;
    Printer< ::franka_action_lib::Errors_<ContainerAllocator> >::stream(s, indent + "  ", v.last_motion_errors);
...
#endif // FRANKA_ACTION_LIB_MESSAGE_ROBOTSTATE_H
